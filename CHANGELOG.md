...
- Added a touch support toggle that starts the Hk4eTouch injector to switch the game to its mobile UI
- Added an editable Hk4eTouch folder setting to the enhancements page
